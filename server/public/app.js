  ...
  function(t, e, n) {
    ...
    ;(function(t, n) {
      ...
      function It(t, e) {
        ...
        for (
          ...
          '__ob__' !== (n = i[a]) &&
            ((r = t[n]),
            (o = e[n]),
            b(t, n) ? r !== o && l(r) && l(o) && It(r, o) : St(t, n, o))
        return t
      }
      function jt(t, e, n) {
        return n
            ...
            if ('string' == typeof e) {
              ...
              ;(l = (t.$vnode && t.$vnode.ns) || U.getTagNamespace(e)),
                (u = U.isReservedTag(e)
                  ...
                  : (n && n.pre) || !i((f = Lt(t.$options, 'components', e)))
      ...
      function _n(t, e, n) {
        var r = !ot()
        'function' == typeof n
          ? ((hn.get = r ? bn(e) : wn(n)), (hn.set = I))
          : ((hn.get = n.get ? (r && !1 !== n.cache ? bn(e) : wn(n.get)) : I),
            (hn.set = n.set || I)),
      ...
      !(function(t) {
        ...
        Object.defineProperty(xn.prototype, '$isServer', { get: ot }),
      ...
      function pr(t, e) {
        ...
        if (
          ...
          for (r in ((Z || Q) && u.value !== c.value && vr(s, 'value', u.value),
          c))
            o(u[r]) &&
              (Un(r)
      ...
      var Pr,
        ...
        Fr = function(t, e, n) {
          if (Nr.test(e)) t.style.setProperty(e, n)
            ...
            t.style.setProperty(O(e), n.replace(Lr, ''), 'important')
          else {
            var r = Ur(e)
            if (Array.isArray(n))
      ...
      function so(t, e) {
        ...
        return (
          e === Gr
            ...
            : (f = (n = (l = Math.max(a, u)) > 0 ? (a > u ? Gr : Zr) : null)
                ? n === Gr
                  ? i.length
                  : c.length
                : 0),
          ...
          if (!k || w || '' === w) {
            ...
            var L = !1 !== a && !J,
              ...
              R = (n._enterCb = N(function() {
                L && (oo(n, E), oo(n, T)),
                  R.cancelled ? (L && oo(n, S), M && M(n)) : D && D(n),
                  (n._enterCb = null)
              }))
            t.data.show ||
              ...
              L &&
                ...
                no(function() {
                  oo(n, S),
                    R.cancelled ||
                      (ro(n, E), F || (po(P) ? setTimeout(R, P) : io(n, s, R)))
                })),
        ...
        if (!i(n._leaveCb)) {
          ...
          var C = (n._leaveCb = N(function() {
            n.parentNode &&
              ...
              _ && (oo(n, l), oo(n, f)),
              C.cancelled ? (_ && oo(n, u), m && m(n)) : (e(), v && v(n)),
              (n._leaveCb = null)
          }))
          y ? y($) : $()
        }
          ...
          C.cancelled ||
            ...
            _ &&
              ...
              no(function() {
                oo(n, u),
                  C.cancelled ||
                    (ro(n, l), b || (po(w) ? setTimeout(C, w) : io(n, s, C)))
              })),
            p && p(n, C),
            _ || b || C())
        }
      ...
      function _o(t, e, n) {
        ...
        if (!o || Array.isArray(r)) {
          for (var i, a, s = 0, c = t.options.length; s < c; s++)
            if (((a = t.options[s]), o))
              (i = P(r, wo(a)) > -1), a.selected !== i && (a.selected = i)
            else if (M(wo(a), r))
      ...
      var Io = function(t) {
        ...
        Mo = T({ tag: String, moveClass: String }, ko)
      function Po(t) {
      ...
      ;(xn.config.mustUseProp = function(t, e, n) {
        ...
        T(xn.options.directives, Oo),
        T(xn.options.components, Fo),
        (xn.prototype.__patch__ = q ? mo : I),
    ...
    var r = n(1),
      o =
        ...
        function() {
          ...
          return (this._self._c || t)('h1', [this._v('THE MAIN COMPONENT')])
        })
    o._withStripped = !0
